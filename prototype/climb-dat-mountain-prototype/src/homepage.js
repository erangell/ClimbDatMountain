...
class Homepage extends LitElement {
  ...
  async load() {
    this.posts = await this.feedModel.list({feedDir: "data/feed", reverse: true})
  ...
  render() {
    ...
    <x-layout>
        ...
        <x-hero slot="center" 
          pageTitle="Sample Class"
          pageDesc="Test Framework for Climb DAT Mountain"></x-hero>

        <x-feed slot="center" posts="${JSON.stringify(this.posts)}"></x-feed>

<x-avatar slot="center" imgFile="pigeonRight.png"></x-avatar>
<x-avatar slot="center" imgFile="pigeonLeft.png"></x-avatar>
<x-avatar slot="center" imgFile="pigeonRight.png"></x-avatar>
<x-avatar slot="center" imgFile="pigeonLeft.png"></x-avatar>
<x-avatar slot="center" imgFile="pigeonRight.png"></x-avatar>
<x-avatar slot="center" imgFile="pigeonLeft.png"></x-avatar>
